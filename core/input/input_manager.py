...
class InputManager(Manager):
    ...
    def __init__(self):
        ...
        self._key_map = {
            ...
            pygame.K_4 : InputManager.Key(Key.NUM_4),
            pygame.K_5 : InputManager.Key(Key.NUM_5),
            pygame.K_6 : InputManager.Key(Key.NUM_6),
            pygame.K_7 : InputManager.Key(Key.NUM_7),
            pygame.K_8 : InputManager.Key(Key.NUM_8),
            pygame.K_9 : InputManager.Key(Key.NUM_9),
