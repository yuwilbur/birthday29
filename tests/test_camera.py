...
data2 = np.empty((WIDTH,HEIGHT,3),dtype=np.uint8)
for foo in camera.capture_continuous(data, use_video_port=True, format='rgb'):
    ...
    surface = pygame.image.frombuffer(data, (WIDTH, HEIGHT), 'RGB')
